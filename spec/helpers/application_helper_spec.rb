...
describe ApplicationHelper do
  ...
  it "returns gravatar_icons for existing email with default size 70" do
    ...
    gravatar_url("test@email.com").should == "http://www.gravatar.com/avatar.php?size=45&gravatar_id=digest"
  end
  ...
  it "returns gravatar_icons for non-existing email" do
    ...
    gravatar_url(nil).should == "http://www.gravatar.com/avatar.php?size=45&gravatar_id=digest"
  end
